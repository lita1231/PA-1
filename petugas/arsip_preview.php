                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <?php 
                                    if(in_array($d['arsip_jenis'], array("png", "jpg", "gif", "jpeg"))) {
                                        echo '<img src="../arsip/'.$d['arsip_file'].'">';
                                    } elseif(in_array($d['arsip_jenis'], array("pdf", "apk", "zip"))) {
                                        echo '<div class="pdf-singe-pro"><a class="media" href="../arsip/'.$d['arsip_file'].'"></a></div>';
                                    } else {
                                        echo '<p>Preview tidak tersedia, silahkan <a target="_blank" style="color: blue" href="../arsip/'.$d['arsip_file'].'">Download di sini.</a></p>';
                                    }
                                    ?>
